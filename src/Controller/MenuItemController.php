...
class MenuItemController extends AbstractController
{
    ...
    public function new(Request $request): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('menu_item_index', [], Response::HTTP_SEE_OTHER);
        }
    ...
    /**
     * @Route("/{menuItemId}", name="menu_item_show", methods={"GET"})
     */
    ...
    /**
     * @Route("/{menuItemId}/edit", name="menu_item_edit", methods={"GET","POST"})
     */
    ...
    /**
     * @Route("/{menuItemId}", name="menu_item_delete", methods={"POST"})
     */
    public function delete(Request $request, MenuItem $menuItem): Response
    {
        if ($this->isCsrfTokenValid('delete'.$menuItem->getMenuItemId(), $request->request->get('_token'))) {
            $entityManager = $this->getDoctrine()->getManager();
